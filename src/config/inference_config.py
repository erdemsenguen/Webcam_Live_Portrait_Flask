...
class InferenceConfig(PrintableConfig):
    ...
    flag_lip_zero: bool = (
        False  # whether let the lip to close state before animation, only take effect when flag_eye_retargeting and flag_lip_retargeting is False
    )
    ...
    flag_pasteback: bool = (
        False  # whether to paste-back/stitch the animated face cropping from the face-cropping space to the original image space
    )
    mask_crop = None
